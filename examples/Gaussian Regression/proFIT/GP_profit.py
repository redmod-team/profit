...
, K_star2 ) # Or : gp . g p _m at ri x _t ra in ( x_star , a , sigma_n )
...
f_star = np . random . m u l t i v a r i a t e _ n o r m a l ( np . zeros ( n_star ) , K_star2 )
...
f_posterior = np . random . m u l t i v a r i a t e _ n o r m a l ( f_bar_star [: ,0] , cov_f_star )
