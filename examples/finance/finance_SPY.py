...
spy = DataReader('SPY', 'yahoo', datetime(2013, 1, 1), datetime(2015, 1, 1))
# print(spy) spy_returns = pd.DataFrame(np.diff(np.log(spy['Adj Close'].values)))
