...
# models.MultioutputGP([xtrain.reshape((-1,1)), ytrain.reshape((-1,1))], [ztrain1.reshape((-1,1)), ztrain2.reshape((-1,1))],
#     kernel_list = [K1, K4], kernel_cross_covariances = {(0,1): K2, (1,0): K3},
#     likelihood_list = [gauss_likelihood,gauss_likelihood])
# Display the model:
print(m)
